...
public class MentalistaController {
	...
	@RequestMapping(path="/")
	public String vistaJoc(){
		return "joc";
	}	
	// feis un metode que atengui a "/reinici" i
	...
	@RequestMapping(path="/intent")
	public String intent (@RequestParam int intent,Model model) {
		intents.add(intent);
		model.addAttribute(intents);
