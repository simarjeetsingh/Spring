...
public class AgendaServiceController {
	...
	@ResponseBody
	public String afegirContacte(@RequestParam String id, @RequestParam String nom, @RequestParam String telefon, String grupo){
		agenda.inserta(id, nom, telefon, grupo);
		return "ok";
	}
	
	/* 
	 * Metodos mios para testear metodo update de la BBDD 
	 * 
	 * */
