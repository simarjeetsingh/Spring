...
public class ControllerTests {
    ...
    @Test
    public void test_obtenir_amb_request_param_fora_de_rang() throws Exception {
        this.mockMvc.perform(get("/personal/consulta?id=9")).andExpect(status().isOk())
        .andExpect(content().string(containsString("no existe persona en esta posicion")));
    ...
    @Test
    public void test_obtenir_amb_path_variable_fora_de_rang() throws Exception {
        this.mockMvc.perform(get("/personal/persona/100")).andExpect(status().isOk())
        .andExpect(content().string(containsString("no existe persona en esta posicion")));    	
    }
    ...
    /* asegurarse de que en la URl /personal/afegir 
     * solo se reciben peticiones POST
     * 
     */
    @Test
    public void test_afegir_error() throws Exception {
 
        this.mockMvc.perform(get("/personal/afegir").param("nom", "Jacinto")).andExpect(status().is4xxClientError());
